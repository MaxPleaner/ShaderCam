 ...
 *
 * All {@link com.otaliastudios.cameraview.filter.BaseFilter}s should have a no-arguments public constructor.
 ...
 *
 */
public abstract class BaseFilterPatch implements Filter {

    private final static String TAG = com.otaliastudios.cameraview.filter.BaseFilter.class.getSimpleName();
    ...
    @NonNull
    @Override
    public BaseFilterPatch copy() {
        BaseFilterPatch copy = onCopy();
        if (size != null) {
